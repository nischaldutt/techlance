...
const Category = () => {
  return (
    <div className="bg-white rounded-lg shadow-lg drop-shadow-lg grid place-items-center shrink-0 w-[170px] h-[207px] px-4 pt-8 pb-4 transition-[margin] duration-300 hover:mt-[-8px]">
  ...
  return (
    <>
      <div className="bg-gray-100 py-2 shadow-lg w-[90%] lg:w-4/5 xl:w-3/5 h-[400px] mx-auto rounded-lg relative">
        <div className="text-center text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 pt-8 pb-2">
